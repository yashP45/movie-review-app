...
import RatingModal from "../components/ReviewModal"; // Import the RatingModal
...
const MovieReviews = () => {
  ...
  const [currentReview, setCurrentReview] = useState<any>(null); // Store current review for editing
